...
// NegBinomialQtlFor returns the inverse of the CDF (quantile) of the NegBinomial distribution, for given probability.
func NegBinomialQtlFor(ρ float64, r int64, p float64) int64 {
	cdf := NegBinomialQtl(ρ, r)
	return cdf(p)
}
